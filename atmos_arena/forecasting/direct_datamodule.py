...
# Local application
from atmos_arena.forecasting.dataset import ERA5DirectDataset
...
class DirectForecastingDataModule(LightningDataModule):
    def __init__(
        self,
        root_dir,
        in_variables,
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            self.data_train = ERA5DirectDataset(
            ...
            if os.path.exists(os.path.join(self.hparams.root_dir, 'val')):
                self.data_val = ERA5DirectDataset(
            ...
            if os.path.exists(os.path.join(self.hparams.root_dir, 'test')):
                self.data_test = ERA5DirectDataset(
