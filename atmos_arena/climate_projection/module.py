...
from climate_projection.climax_climatebench_arch import ClimaXClimateBench
from climate_projection.stormer_climatebench_arch import StormerClimateBench
...
class ClimateBenchModule(LightningModule):
    """Lightning module for climate projection.

    Args:
        net: ClimaXClimateBench or StormerClimateBench model.
    ...
    def __init__(
        self,
        net: Union[ClimaXClimateBench, StormerClimateBench],
        pretrained_path: str = "",
        lr: float = 5e-4,
        beta_1: float = 0.9,
        beta_2: float = 0.99,
    ...
    def training_step(self, batch: Any, batch_idx: int):
        x, y, lead_times, variables, out_variables = batch # lead_times is set to 0 for this task
    ...
    def test_step(self, batch: Any, batch_idx: int):
        ...
        all_loss_dicts = [
            m(pred, y, self.denormalization, vars=out_variables, lat=self.lat, clim=self.test_clim, log_postfix="") for m in metrics
        ]
